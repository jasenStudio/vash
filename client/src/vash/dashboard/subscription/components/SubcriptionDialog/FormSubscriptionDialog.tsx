...
import { useSubcriptionDialog } from "../../hooks";
...
export const FormSubscriptionDialog: FC = memo(() => {
  ...
  const {
    ...
    form,
    typeComponent,
  } = useSubcriptionDialog({ formAccountSchema: formSchema });
  ...
  const formTitleByAction = "Subcriptions";
